...
contract FDOGE_NFT is ERC721 {
    ...
    address private creatorAddress ;//設計團隊操作
    ...
    function pre_mint() public payable{//預售
        require(preSale == true,"Pre mint is not yet");
    ...
    function mint() public payable{ // 第二次發售鑄造新的Waby
